...
api: true
explorer: false
permalink: 'cvo/get-azure-vsa-metadata-supported-features.html'
...
[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/azure/vsa/metadata/supported-features`#
