...
api: true
explorer: false
permalink: 'cvo/get-azure-ha-metadata-supported-features.html'
...
[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/azure/ha/metadata/supported-features`#
