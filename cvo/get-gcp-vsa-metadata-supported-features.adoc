...
api: true
explorer: false
permalink: 'cvo/get-gcp-vsa-metadata-supported-features.html'
...
[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/gcp/vsa/metadata/supported-features`#
