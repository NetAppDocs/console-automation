...
api: true
explorer: false
permalink: 'cvo/get-aws-ha-metadata-ebs-volume-types.html'
summary: 'Retrieve supported EBS volume types'
---

= Retrieve supported EBS volume types

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/aws/ha/metadata/ebs-volume-types`#
