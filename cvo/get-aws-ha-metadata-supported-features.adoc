...
api: true
explorer: false
permalink: 'cvo/get-aws-ha-metadata-supported-features.html'
...
[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/aws/ha/metadata/supported-features`#
