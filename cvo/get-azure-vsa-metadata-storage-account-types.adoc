...
api: true
explorer: false
permalink: 'cvo/get-azure-vsa-metadata-storage-account-types.html'
summary: 'Retrieve supported Azure storage account types'
---

= Retrieve supported Azure storage account types

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/azure/vsa/metadata/storage-account-types`#
