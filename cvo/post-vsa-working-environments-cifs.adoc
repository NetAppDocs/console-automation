...
api: true
explorer: false
permalink: 'cvo/post-vsa-working-environments-cifs.html'
summary: 'Set up a new CIFS configuration'
---

= Set up a new CIFS configuration

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/vsa/working-environments/{workingEnvironmentId}/cifs`#
