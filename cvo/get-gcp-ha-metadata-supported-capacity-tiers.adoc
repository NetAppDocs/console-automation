...
api: true
explorer: false
permalink: 'cvo/get-gcp-ha-metadata-supported-capacity-tiers.html'
...
[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/gcp/ha/metadata/supported-capacity-tiers`#
