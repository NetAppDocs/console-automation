...
api: true
explorer: false
permalink: 'cvo/get-gcp-vsa-metadata-supported-capacity-tiers.html'
summary: 'Retrieve supported capacity tiers for Google Cloud disk types'
---

= Retrieve supported capacity tiers for Google Cloud disk types

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/gcp/vsa/metadata/supported-capacity-tiers`#
