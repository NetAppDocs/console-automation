...
api: true
explorer: false
permalink: 'dw/get-license-subscriptions-subscription-.html'
summary: 'Retrieve subscription information using the subscription ID (deprecated)'
---

= Retrieve subscription information using the subscription ID (deprecated)

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/license/subscriptions/subscription/{subscriptionId}`#



Retrieves the subscription information for a specified subscription ID. A newer version of this deprecated endpoint is available https://docs.netapp.com/us-en/console-automation/dw/get-license-subscriptions-subscription.html[here.]
