...
summary: 'Retrieve subscription information using the subscription ID'
---

= Retrieve subscription information using the subscription ID

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/license/subscriptions/subscription`#
