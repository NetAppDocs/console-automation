...
https://docs.netapp.com/us-en/console-setup-admin/task-sign-up-saas.html[Sign up or log in to NetApp Console^]. 
...
* https://docs.netapp.com/us-en/console-automation/platform/create_user_token.html[Create user token]
* https://docs.netapp.com/us-en/console-automation/platform/create_service_token.html[Create service token]
