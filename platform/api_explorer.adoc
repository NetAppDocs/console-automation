...
.Prerequisites
You need to have an account for the Console. Refer to https://docs.netapp.com/us-en/bluexp-setup-admin/task-sign-up-saas.html[Sign up or log in to NetApp Console^] for more information.
...
. Navigate to the link:https://docs.netapp.com/us-en/bluexp-automation/tenancy/post-tenancy-resource-discover.html[Discover an external resource] endpoint in the Accounts (Tenancy) service API documentation.
