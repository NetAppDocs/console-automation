...
* You must have an account for the Console. You created this account when you first logged in to the Console website and it was displayed at the top of the Console user interface. See, https://docs.netapp.com/us-en/console-setup-admin/task-sign-up-saas.html[Sign up or log in to NetApp Console^].  
