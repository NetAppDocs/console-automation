...
api: true
explorer: false
permalink: 'tenancyv4/post-resourcegroups-resources.html'
summary: 'Add resources to a resource group'
---

= Add resources to a resource group

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/resourcegroups/{resourcegroup_id}/resources`#



Adds resources to the specified resource group.
