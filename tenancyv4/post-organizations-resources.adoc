...
api: true
explorer: false
permalink: 'tenancyv4/post-organizations-resources.html'
summary: 'Add resources to an organization'
---

= Add resources to an organization

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/organizations/{organization_id}/resources`#
