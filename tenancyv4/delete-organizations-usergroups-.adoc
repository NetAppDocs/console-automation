...
api: true
explorer: false
permalink: 'tenancyv4/delete-organizations-usergroups-.html'
summary: 'Remove a user group from an organization'
---

= Remove a user group from an organization

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/organizations/{organization_id}/usergroups/{usergroup_id}`#
