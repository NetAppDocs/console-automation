...
api: true
explorer: false
permalink: 'tenancyv4/post-partnerships-resourceadmins.html'
summary: 'Add users with the ResourceAdmin role to a partnership'
---

= Add users with the ResourceAdmin role to a partnership

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/partnerships/{partnership_id}/resourceadmins`#
