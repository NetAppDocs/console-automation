...
api: true
explorer: false
permalink: 'tenancyv4/post-folders-users.html'
summary: 'Add users to a folder'
---

= Add users to a folder

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/folders/{folder_id}/users`#



Adds users to the specified folder.
