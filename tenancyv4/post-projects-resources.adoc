...
api: true
explorer: false
permalink: 'tenancyv4/post-projects-resources.html'
summary: 'Add resources to a project'
---

= Add resources to a project

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/projects/{project_id}/resources`#



Adds resources to the specified project.
...
Indicates the resources to add to the project.
