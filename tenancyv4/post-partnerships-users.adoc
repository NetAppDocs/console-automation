...
api: true
explorer: false
permalink: 'tenancyv4/post-partnerships-users.html'
summary: 'Add users to a partnership'
---

= Add users to a partnership

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/partnerships/{partnership_id}/users`#



Adds users to the specified partnership.
...
{
  "description": "Adding user to the partnership with Acme",
