...
api: true
explorer: false
permalink: 'tenancyv4/delete-projects-roles-users-.html'
summary: 'Remove a user from a project'
---

= Remove a user from a project

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/projects/{project_id}/roles/{role_id}/users/{user_id}`#
...
```
Status: 204, Indicates if the user was removed from a project.
```
