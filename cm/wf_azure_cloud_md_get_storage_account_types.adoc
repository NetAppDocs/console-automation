...
* <<Get Azure storage account types for a single node, Single Node>>
* <<Get Azure storage account types for a high availability pair, HA pair>>

== Get Azure storage account types for a single node
...
== Get Azure storage account types for a high availability pair
