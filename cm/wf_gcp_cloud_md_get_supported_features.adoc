...
* <<Get supported features for a single node, Single Node>>
* <<Get supported features for a high availability pair, HA pair>>

== Get supported features for a single node
...
== Get supported features for a high availability pair
