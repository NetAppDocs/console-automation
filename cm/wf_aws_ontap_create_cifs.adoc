...
You can use this workflow to create a CIFS server configuration for a HA system.
...
Perform the workflow link:wf_aws_cloud_get_wes.html#get-systems-a-high-availability-pair[Get systems] and choose the `publicId` value of the system for the `workingEnvironmentId` path parameter.
