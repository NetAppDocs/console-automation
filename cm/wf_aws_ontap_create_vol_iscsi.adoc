...
Perform the workflow link:wf_aws_ontap_create_quote.html#create-quote-for-a-high-availability-pair[Create quote].This is a recommended step but is not mandatory.
