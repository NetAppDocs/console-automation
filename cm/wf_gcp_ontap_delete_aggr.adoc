...
Perform the workflow link:wf_gcp_ontap_get_aggrs.html#get-aggregates-for-a-single-node[Get aggregates] and choose the `name` value of the required aggregate for the `aggregateName` path parameter.
...
Perform the workflow link:wf_gcp_ontap_get_aggrs.html#get-aggregates-for-a-high-availability-pair[Get aggregates] and choose the `name` value of the required aggregate for the `aggregateName` path parameter.
