...
Perform the workflow link:wf_azure_ontap_create_aggr.html[Create an aggregate] to create an aggregate with the name `aggr2`. Use `aggr2` value for the `aggregateName` path parameter.
