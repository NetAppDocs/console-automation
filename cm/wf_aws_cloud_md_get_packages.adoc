...
* <<Get packages for a single node, Single Node>>
* <<Get packages for a high availability pair, HA pair>>

== Get packages for a single node
...
== Get packages for a high availability pair
You can use this workflow to retrieve the packages information for an HA system.
