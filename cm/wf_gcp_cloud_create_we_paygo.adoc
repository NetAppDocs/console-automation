...
[.lead]
You can use this workflow to create a new Google Cloud Cloud Volumes ONTAP system using a pay-as-you-go (PAYGO) subscription.
...
You can use this workflow to create a single node system with PAYGO subscription.
...
Perform the workflow link:wf_gcp_cloud_md_get_projects.html#get-projects-for-a-single-node[Get projects] and choose the `projectId` value of the required project for `project` parameter in step 8.
...
Perform the workflow link:wf_gcp_cloud_md_get_service_accounts.html#get-service-accounts-for-a-single-node[Get service accounts] workflow and choose the `email` value of the required service accounts for the `gcpServiceAccount` parameter in step 8.
...
You can use this workflow to create an HA system with PAYGO subscription.

=== 1. Select the region
Perform the workflow link:wf_gcp_cloud_md_get_regions.html#get-regions-for-a-high-availability-pair[Get regions] and do the following:
...
=== 3. Select the project
Perform the workflow link:wf_gcp_cloud_md_get_projects.html#get-projects-for-a-high-availability-pair[Get projects] and choose the `projectId` value of the required project for `project` parameter in step 9.
...
Perform the workflow link:wf_gcp_cloud_md_get_service_accounts.html#get-service-accounts-for-a-high-availability-pair[Get service accounts] workflow and choose the `email` value of the required service accounts for the `gcpServiceAccount` parameter in step 9.
