...
* <<Get projects for a single node, Single Node>>
* <<Get projects for a high availability pair, HA pair>>

== Get projects for a single node
...
== Get projects for a high availability pair
