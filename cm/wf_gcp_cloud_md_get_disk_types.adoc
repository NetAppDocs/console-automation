...
* <<Get Google Cloud disk types for a single node, Single Node>>
* <<Get Google Cloud disk types for a high availability pair, HA pair>>

== Get Google Cloud disk types for a single node
...
== Get Google Cloud disk types for a high availability pair
