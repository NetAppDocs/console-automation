...
* <<Get EBS volume types for a single node, Single Node>>
* <<Get EBS volume types for a high availability pair, HA pair>>

== Get EBS volume types for a single node
...
== Get EBS volume types for a high availability pair
You can use this workflow to get the EBS volume types for an HA system.
