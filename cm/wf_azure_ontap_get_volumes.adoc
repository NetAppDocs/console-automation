...
* <<Get a volume for a single node, Single Node>>
* <<Get a volume for a high availability pair, HA pair>>


== Get a volume for a single node
...
== Get a volume for a high availability pair
