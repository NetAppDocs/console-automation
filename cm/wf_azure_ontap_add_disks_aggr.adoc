...
Perform the workflow link:wf_azure_ontap_create_aggr.html#create-aggregate-for-a-single-node[Create aggregate] to create an aggregate with the name `aggr2` and choose `aggr2` for the `aggregateName` path parameter.
