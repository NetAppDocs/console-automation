...
Perform the workflow link:wf_azure_cloud_md_get_regions.html#get-azure-regions-for-a-single-node[Get regions] and choose the `name` value of the required region for the `region` parameter in step 11.
...
Perform the workflow link:wf_azure_cloud_md_get_regions.html#get-azure-regions-for-a-high-availability-pair[Get regions] and choose the `name` value of the required region for the `region` parameter in step 10.
