...
You can use this workflow to retrieve the system details of a single node system.
...
You can use this workflow to retrieve the system details of an HA system.
