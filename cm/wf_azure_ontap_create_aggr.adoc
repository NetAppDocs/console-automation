...
Perform the link:wf_azure_cloud_md_get_storage_account_types.html#get-azure-storage-account-types-for-a-high-availability-pair[Get Azure Storage Account Types] workflow and choose the desired storage type:
