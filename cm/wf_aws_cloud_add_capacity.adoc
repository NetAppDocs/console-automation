...
* <<Add capacity for a single node, Single Node>>
* <<Add capacity for a high availability pair, HA pair>>

== Add capacity for a single node
...
== Add capacity for a high availability pair
