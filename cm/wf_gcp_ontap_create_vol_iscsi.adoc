...
Perform the workflow link:wf_gcp_ontap_create_quote.html#create-a-quote-for-a-single-node[Create a quote].This is a recommended step but is not mandatory.
...
Perform the workflow link:wf_gcp_ontap_create_quote.html#create-a-quote-for-a-high-availability-pair[Create a quote].This is a recommended step but is not mandatory.
...
Perform the workflow link:wf_gcp_ontap_get_aggrs.html#get-aggregates-for-a-high-availability-pair[Get aggregates] and choose the `name` for the `aggregateName` value.
...
Perform the workflow link:wf_gcp_ontap_get_igroups.html#get-igroups-for-a-high-availability-pair[Get iGroups] and choose the igroups for the `iscasiInfo` -> `igroups` value. Also select the `osType` value for the `iscasiInfo` -> `osName`.
