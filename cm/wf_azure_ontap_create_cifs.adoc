...
* <<Create CIFS server configuration for a single node, Single Node>>
* <<Create CIFS server configuration for a high availability pair, HA pair>>

== Create CIFS server configuration for a single node
You can use this workflow to create CIFS server configuration for a single node system.
...
== Create CIFS server configuration for a high availability pair
