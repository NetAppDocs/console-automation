...
.AWS
--
Perform the workflow link:wf_aws_cloud_get_wes.html[Get systems] and choose the `tenantId` value.
--

.Azure
--
Perform the Azure workflow link:wf_azure_cloud_get_wes.html[Get systems] and choose the `tenantId` value.
--

.Google Cloud
--
Perform the Google Cloud workflow link:wf_gcp_cloud_get_wes.html[Get systems] and choose the `tenantId` value.
--
====
