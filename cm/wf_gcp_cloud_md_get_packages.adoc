...
* <<Get Google Cloud packages for a single node, Single Node>>
* <<Get Google Cloud packages for a high availability pair, HA pair>>

== Get Google Cloud packages for a single node
You can use this workflow to retrieve Google Cloud packages in a single node system.
