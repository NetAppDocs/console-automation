...
* If a CIFS configuration does not exist, perform the workflow link:wf_gcp_ontap_create_cifs.html#create-cifs-for-single-node[Create CIFS server configuration] to create one. 
...
You can use this workflow to create a volume using CIFS protocol for a HA system.
