...
Perform the workflow link:wf_aws_cloud_md_get_regions.html#get-regions-for-a-high-availability-pair[Get regions] and choose the `code` value for the `region` query parameter.
