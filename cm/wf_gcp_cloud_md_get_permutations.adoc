...
* <<Get Google Cloud permutations for a single node, Single Node>>
* <<Get Google Cloud permutations for a high availability pair, HA pair>>

== Get Google Cloud permutations for a single node
...
== Get Google Cloud permutations for a high availability pair
