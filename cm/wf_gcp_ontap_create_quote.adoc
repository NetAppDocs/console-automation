...
=== 2. Select the aggregate
Perform the link:wf_gcp_ontap_get_aggrs.html#get-aggregates-for-a-high-availability-pair[Get aggregates] workflow and choose the `name` value of the required aggregate for the `aggregateName` parameter in the JSON input.
