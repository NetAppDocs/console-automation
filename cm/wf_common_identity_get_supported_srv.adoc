...
summary: "You can use this workflow to retrieve information about the NetApp Console supported services including the _client id_ and _account id_ values."
---
...
[.lead]
You can use this workflow to retrieve information about the NetApp Console supported services including the _client id_ and _account id_ values.

[NOTE]
This workflow describes how to use the REST API to retrieve the two ID values. You can also use the Console web UI to get these values. See link:../platform/get_identifiers.html[Get required identifiers] for more information.
