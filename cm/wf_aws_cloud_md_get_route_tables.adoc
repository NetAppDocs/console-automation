...
== Step 2. Get the VPC
Perform the workflow link:wf_aws_cloud_md_get_vpcs.html#get-vpcs-for-a-high-availability-pair[Get VPCs] and choose the `vpcId` value of the required VPC for the `vpcId` query parameter.
