...
* <<Create CIFS for a single node, Single Node>>
* <<Create CIFS for a high availability pair, HA pair>>

== Create CIFS for a single node
...
== Create CIFS for a high availability pair
